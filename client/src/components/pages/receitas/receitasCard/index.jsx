    ...
    <ReceitasCardWrapper>
      <div className="receita_card__container">
        ...
        <div className="receita_card__text">
          ...
          <p>
            Este bolo sem glúten vai fazer você entrar no espírito festivo, com
            maçãs doces, canela, gengibre e noz-moscada.
          </p>
          <p>
            <span>Dificuldade: </span>2
          </p>
          <div className="receita_card__text--tag">
            <p>
              Tags: <span>{"Bolos"}</span>, <span>{"Sem glútem"}</span>
            </p>
          </div>
          <ReceitaCardNota />
        </div>
