...
export default function ReceitasFavoritasCard() {
  ...
  useEffect(() => {
    getRecipe(setReceitas);
  }, []);
  // const [ descricao, nome ] = receitas;
  
  // const receita = receitas.filter(receita => receita.id == 1);
      ...
      <div className="receitas_favoritas__card-container">
        <div className="receitas_favoritas__card-container--card">
          <div className="receitas_favoritas__card-container--imagem-container">
            <img
              className="receitas_favoritas__card-container--imagem"
              src={appleCake}
            />
          </div>
          <div className="receitas_favoritas__card-container--caption_container">
            <div className="card-container--caption">
              ...
              <p>
                Este bolo sem glúten vai fazer você entrar no espírito festivo,
                com maçãs doces, canela, gengibre e noz-moscada.
              </p>
              {/* <h3>{receita.nome}</h3>
        ...
        <div className="receitas_favoritas__card-container--card">
          ...
          <div className="receitas_favoritas__card-container--caption_container">
            <div className="card-container--caption">
              ...
              <p>
                Cupcakes simples com especiarias, cobertos com uma deliciosa
        ...
        <div className="receitas_favoritas__card-container--card">
          ...
          <div className="receitas_favoritas__card-container--caption_container">
            <div className="card-container--caption">
              ...
              <p>
                Asse isso e seu rosto vai doer de tanto que você estará
                sorrindo, mastigando e esperando por outro.
              </p>
              <BotaoVerdeInlined texto="Ver mais" />
            </div>
          </div>
